...
import com.rcrucetastudios.moviesapp.DetailActivity;
        ...
        view.setOnClickListener(new View.OnClickListener(){
            public  void onClick(View v){
                ...
                if(pos != RecyclerView.NO_POSITION){
                    ...
                    intent.putExtra("posted_path", movieList.get(pos).getPosterPath());
                    intent.putExtra("overview", movieList.get(pos).getOverview());
                    intent.putExtra("vote_average", Double.toString(movieList.get(pos).getVoteAverage()));
                    intent.putExtra("release_date", movieList.get(pos).getReleaseDate());
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    mContext.startActivity(intent);
                    Toast.makeText(v.getContext(), "You Clicked in this Movie" + clickedDataItem.getOriginalTitle(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
