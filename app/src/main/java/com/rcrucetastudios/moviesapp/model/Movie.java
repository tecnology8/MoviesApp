package com.rcrucetastudios.moviesapp.model;
...
public class Movie {
    ...
    String baseImageUrl = "httpps://image.tmdb.org/t/p/w500";
    ...
    public  void isAdult(boolean adult){
        this.adult = adult;
    }
    ...
    public String setOriginalTitle(String originalTitle){
